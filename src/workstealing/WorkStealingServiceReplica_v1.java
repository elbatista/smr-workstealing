 ...
 * @author elbatista
 */
public final class WorkStealingServiceReplica_v1 extends ParallelServiceReplica {
    private final boolean[] exec_flags;
    private final AtomicInteger[][] markers;
    private final Semaphore[][] semaphores;
    
    public WorkStealingServiceReplica_v1(
    ...
    protected void initWorkers(int n, int id, int duration, int warmup) {
        statistics = new ThroughputStatistics(id, n, "results_defaultStealer_v1_" + id + ".txt", "defaultStealer_v1", duration, warmup);
        //for (int i = 0; i < n; i++) {
        System.out.println("Starting " + n + " steal-on-empty-queue workstealing threads");
