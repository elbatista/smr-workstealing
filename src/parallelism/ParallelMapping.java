...
public class ParallelMapping {
    ...
    public static int CONC_ALL = 98;
    public static int SYNC_ALL = 99;
    public static int CONFLICT_RECONFIGURATION = 97;

    protected ClassToThreads[] classes;
   ...
   // public static int THREADS_RECONFIGURATION = -4;
    ...
    public ClassToThreads[] getClasses() {
        return classes;
    }
